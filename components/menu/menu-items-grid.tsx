...
export function MenuItemsGrid() {
  ...
  const items = useMemo(() => {
    console.log(`[v0] MenuItemsGrid: Filtering ${allItems.length} items for category "${selectedCategory}"`)
    ...
    console.log(`[v0] MenuItemsGrid: Found ${unique.length} items for category "${selectedCategory}"`)
    return unique
